...
{{if .Keterangan}}
The reviewer suggested minor revisions to the abstract when turning it into a full manuscript for proceeding: 

{{.Keterangan}}
{{- end}}

In order to submit the full manuscript, you will be required to:
